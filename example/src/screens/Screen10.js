    ...
    return <BaseScreen number={10}>
      <CT.Row>
          ...
          <CT.ImageBackground uri={uri} blurRadius={ Platform.OS == 'ios' ? 5 : 3 }>
            <CT.Row backgroundColor='rgba(36,159,134,.76)'>
              <CT.Float style={{left: 120, bottom: 5}} flow='row'>
                <TLabel theme='H1' >Jasmine C. <TLabel theme='H4'>, 52</TLabel></TLabel>
        ...
        <CT.Row flex={1} backgroundColor='rgb(61,73,108)'>
          <CT.Float><TLabel theme='H7' style={{left: 125, top: 5}} /></CT.Float>
          <CT.Row marginTop={50}>
            ...
            <TList name='bar-chart' color='rgb(25,226,190)' text='7h43m' borderBottom={false}/>
          </CT.Row>
        </CT.Row>
      ...
      <TLabel color='rgba(255,255,255,.5)' theme='H1' style={{position: 'absolute', right: -70, top: 120, transform: [{ rotate: '90deg'}] }} >JacobLauritzen</TLabel>
    </BaseScreen>
  }
}
  ...
  return <CT.Row paddingHorizontal={10}>
    ...
    <CT.Col flex={6} borderColor='rgba(192,187,226,.75)' borderBottomWidth={borderBottomWidth}>
      ...
      <CT.Col xAlign='center' yAlign='flex-end' borderColor='rgba(192,187,226,.75)' borderBottomWidth={borderBottomWidth}>
        <TLabel theme='H5' style={{fontFamily: 'GillSans'}} color='white'>{props.text}</TLabel>
      </CT.Col>
    </CT.Col>
  </CT.Row>
}
