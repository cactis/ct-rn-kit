            ...
            <CT.Grid padding={20}>
              ...
              <CT.Row xAlign="center">
                <CT.IconLabel
                  icon=<CT.Icon
                    name="bucket"
                    color="rgba(177,19,83,.84)"
                    iconSet="Entypo"
                    size={30}
                  />
                  label=<CT.Label theme="H6" text="USA, North Carolina" />
                />
              </CT.Row>
            </CT.Grid>
          </CT.ImageBackground>
        ...
        <CT.Row flex={1.5}>
          <CT.Row>
            <CT.Col flex={3} padding={20}>
              <CT.Col>
                <CT.Row
                  style={{ borderBottomWidth: 0.5, borderColor: '#aaa' }}
                  xAlign="center"
                >
                  <TTLabels texts={['type of wine', 'Red, sweet']} />
                </CT.Row>
                <CT.Row
                  style={{ borderBottomWidth: 0.5, borderColor: '#aaa' }}
                  xAlign="center"
                >
                  <TTLabels texts={['size', '750 ml']} />
                </CT.Row>
                <CT.Row xAlign="center">
                  <TTLabels texts={['price', '$ 7.8']} />
                </CT.Row>
              </CT.Col>
              <CT.Col style={{ borderLeftWidth: 0.5, borderColor: '#aaa' }}>
                <CT.Row
                  ...
                  xAlign="center"
                >
                  <CT.Div style={{ paddingLeft: 20 }}>
                    <TTLabels texts={['year', '2015']} />
                  </CT.Div>
                </CT.Row>
                <CT.Row
                  style={{ borderBottomWidth: 0.5, borderColor: '#aaa' }}
                ...
                >
                  <CT.Div style={{ paddingLeft: 20 }}>
                    <TTLabels texts={['vol', '12.0%']} />
                  </CT.Div>
                </CT.Row>
                <CT.Row xAlign="center">
                  <CT.Div style={{ paddingLeft: 20 }}>
                    <TTLabels texts={['good well with', 'picnic-foods']} />
                  </CT.Div>
                </CT.Row>
              </CT.Col>
            </CT.Col>
          ...
          <CT.Row>
            <CT.Row
              ...
              margin={10}
              paddingVertical={10}
              style={{ borderTopWidth: 0.5, borderColor: 'rgb(149,139,103)' }}
            >
              <CT.Label theme="H5" text="User rating:" />
              <CT.IconLabel
                icon=<CT.Icon name="thumbs-up" size={18} />
                label=<CT.Label theme="H6" text="2,352" />
              />
            </CT.Row>
            <CT.Row padding={10}>
              <CT.Label theme="H1" font="Georgia">
                Description
              </CT.Label>
              <CT.Space size={10} />
              <CT.Text
