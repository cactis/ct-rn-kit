...
export class Screen11 extends React.Component {
  ...
  render() {
    ...
    return (
      <BaseScreen number={11}>
        <TheRow flex={1.5} xAlign="flex-end">
          <TheLabel
            theme="H1"
            size={30}
            style={{ fontFamily: 'TrebuchetMS' }}
          />
        ...
        <TheRow flex={0.7} layout="row">
          <Tag borderBottomWidth={3} style={{ fontWeight: '800' }}>
            INGREDIENTS
          </Tag>
          <Tag>DIRECTION</Tag>
        </TheRow>
        <TheRow flex={2} xAlign="flex-start" paddingHorizontal={50}>
          <List />
          <List />
          <List />
          <List />
...
const TheRow = props => <CT.Row {...props} padding={20} />

const TheLabel = props => <CT.Label color="rgba(30,81,91,.9)" {...props} />

const List = props => {
  return (
    <CT.Row layout="row" yAlign="center">
