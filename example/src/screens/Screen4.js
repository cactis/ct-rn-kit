...
const TIcon = props => (
  <Icon {...props} size={props.size || 26} color={props.color || 'white'} />
)
  ...
  render() {
    ...
    return (
      <BaseScreen
        ...
        number="4"
        backgroundColor="rgba(#F1EFF6,.32)"
      >
        <Header flexGrow={1} style={style.header}>
          ...
          <Row height={80}>
            <Col>
              <Center>
                <Label theme="H8" color="white">
                  Followers
                </Label>
                <Label theme="H2" color="white">
                  3,345
                </Label>
              </Center>
            </Col>
    ...
    <Row marginTop={10}>
      ...
      <Row>
        <Col justifyContent="center" alignItems="flex-end" height={size}>
          <Image
            style={{ ...props.style.listImage, ...props.style.bigImage }}
          />
        </Col>
        <Space size={5} />
