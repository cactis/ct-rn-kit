      ...
      <BaseScreen number={13}>
        ...
        >
          <CT.Row flex={1} align="center" marginTop={40}>
            ...
            <TText theme="H1" font="HelveticaNeue-Bold">
              Des Glaneuses
            </TText>
          </CT.Row>
          <CT.Row flex={9} onPanResponderTerminationRequest={() => false}>
            <CT.List
              ...
              getItemLayout={(data, index) => ({
                length: CARDWIDTH + 3 * PADDING,
                offset: -300,
                index
              })}
              renderItem={({ item }) => (
                <CT.Card width={CARDWIDTH}>
                  <CT.ImageBackground>
                    ...
                    <CT.Float
                      ...
                      alignSelf="center"
                    >
                      <TText font="Palatino-Italic" align="center">
                        To be an artist is to believe in life.
                      </TText>
                      <CT.Space />
                      <TText font="GeezaPro" theme="H8">
                        - Henry Moore
                      </TText>
                    </CT.Float>
                  </CT.ImageBackground>
          ...
          <CT.Row flex={1} align="center" layout="row" paddingBottom={30}>
            <CT.Div padding={15}>
              <CT.Avatar
                size={40}
                uri="https://images.pexels.com/photos/206563/pexels-photo-206563.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
              />
            </CT.Div>
