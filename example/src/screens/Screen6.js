...
export class Screen6 extends React.Component {
  state = {
    uri:
      'https://images.pexels.com/photos/775199/pexels-photo-775199.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260'
  }
  render() {
    return (
      <BaseScreen number={6}>
        <CT.ImageBackground uri={this.state.uri}>
          <CT.Row>
            <CT.Space />
          </CT.Row>
          <CT.Row padding={20}>
            ...
            <CT.Row justifyContent="flex-end" marginBottom={20}>
              <CT.Button
                theme="pill"
                backgroundColor="rgba(223,232,241,.9)"
                color="white"
                title="See Details"
              />
            </CT.Row>
...
const Info = props => {
  return (
    <CT.Div alignItems="center" flow="column">
      <CT.Text theme="H1" color="white" style={{ textAlign: 'center' }}>
        {props.text}
      </CT.Text>
      <CT.IconLabel
        padding={1}
