...
export class Screen6 extends Component {
  render() {
    return <BaseScreen number={6} scrollable={false}>
      ...
      <Row padding={20}>
        ...
        <Row flex={0} height={100} flexDirection='row' alignItems='center' justifyContent='space-evenly'>
          <Info text='2h' label='Tourtime' icon='clock-o' />
          <Info text='$10' label='Prie' icon='ios-pricetag' iconSet='Ionicons' />
          <Info text='4' label='Person' icon='md-people' iconSet='Ionicons' />
          <Info text='15h' label='Close' icon='bell-sleep' iconSet='MaterialCommunityIcons' />
        </Row>
