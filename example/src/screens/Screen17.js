...
export class Screen17 extends Component {
  render() {
    return <BaseScreen
      ...
      <CT.Row flex={1.2}>
        <CT.Col flex={2}>
          <CT.Text theme='H1' size={50} color='white'>{`New\nAccount`}</CT.Text>
        </CT.Col>
        <CT.Col align='center'>
          <CT.Label color='white' theme='H1' size={40}>1<CT.Label color='rgb(250,250,250)'> / 2</CT.Label></CT.Label>
          <CT.Label color='white' theme='H8' size={14}>STEPS</CT.Label>
        </CT.Col>
      </CT.Row>
      <CT.Row flex={1.3}>
        <CT.Col xAlign='center' flex={0} paddingRight={20}>
          <CT.Icon name='link' iconSet='Entypo' color='rgb(169,177,190)' size={40} backgroundColor='rgb(59,60,68)' borderWidth={5} borderColor='white' />
        </CT.Col>
        <CT.Col xAlign='center'>
          <CT.Text color='rgb(178,179,191)' theme='H6'>{`Upload a profile picture\n(optional)`}</CT.Text>
        </CT.Col>
      </CT.Row>
      <CT.Row flex={2.5}>
