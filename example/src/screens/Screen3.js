...
import { Grid, Col, Row, Header, Body, Footer, Screen, Page, Square, Padding,  RoundButton, ImageBackground,  View, SafeArea, Scroll, Center, Photo, Text, Label, Setting, Avatar, Circle, Card, H1, H2, H3, P } from '../../..'
    ...
    return <BaseScreen number='3'>
      <ImageBackground>
        <Header style={{flex: 4.5, alignItems: 'center', justifyContent: 'flex-end'}}>
          <Circle size={70}><H1 style={{fontSize: 30}}>Q</H1></Circle>
        </Header>
