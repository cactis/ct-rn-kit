...
export class BaseScreen extends Component {
  render() {
    return <Screen safeAreaDisabled={true} {...this.props}>
      <Text style={{color: 'rgba(154,141,141,.86)', padding: 3, fontSize: 14, position: 'absolute', right: 30, bottom: 0, zIndex: 1000}}>#tutorial {this.props.number}</Text>{this.props.children}
    </Screen>
  }
}
